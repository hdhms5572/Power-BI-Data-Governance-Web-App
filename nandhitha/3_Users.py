...
with col1:
    ...
    ax.set_title("Group User Access Rights", fontsize=10, color="black")
    ax.axis("equal")
    st.pyplot(fig)
...
with col2:
    ...
    ax.set_xlabel("User Count", fontsize=9, color="black")
    ax.set_ylabel("Email Domain", fontsize=9, color="black")
