...
# # On toggle change, reset selection
...
# # Multiselect synced with checkbox state
# selected_ws_names = st.multiselect(
#     "🔀 Choose Workspaces",
#     options=workspace_names,
#     default=st.session_state.last_selected_ws,
#     key="ws_selector"
# )
...
# # Show button only after workspace selection
