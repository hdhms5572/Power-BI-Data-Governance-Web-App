...
# # ---------------------------------------------
# # ✅ NEW UTIL 1 — Shared Activity File Upload
# # ---------------------------------------------
...
#             st.stop()
#     else:
#         st.success("✅ Activity CSV already uploaded.")
...
# # ---------------------------------------------
# # ✅ NEW UTIL 2 — Combined Workspace Data Loader
# # ---------------------------------------------
# # def get_combined_workspace_data():
...
# #     selected_ws_ids = [workspace_map.get(name, "") for name in st.session_state.last_selected_ws]
...
# #     return (
# #         pd.concat(reports_df_list, ignore_index=True),
# #         pd.concat(datasets_df_list, ignore_index=True),
# #         pd.concat(users_df_list, ignore_index=True)
# #     )
...
#     # Only consider artifact activity within the workspace scope
...
#     # Get latest activity per artifact
...
#     # Create ArtifactId → Timestamp map
...
#     # Apply activity labels and timestamps to reports & datasets
