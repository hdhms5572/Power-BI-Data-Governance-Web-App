...
page = st.selectbox("What are looking for...", ("Reports", "Datasets", "Users"), index=None, placeholder="Please Select")
...
if access_token and workspace_id and user_email:
    ...
    if reports_data and datasets_data and users_data:
        ...
        # RLS Filtering: based on user email domain
        ...
        if page:
            ...
            # Display
            st.title(f"🔒 Power BI {page} (Restricted)")
            ...
            st.warning("Please select what you are looking for.")
    else:
